...
//import com.cg.uas.util.ConnectionDB;
...
//			preparedStatement.setString(1,student.getRollno());			
			...
			preparedStatement.setString(4,programOffered.getDuration());
			...
			/*preparedStatement = connection.prepareStatement(IQueryMapper.VIEW_PROGRAM_NAME);
		...
		try{
			...
			if(resultSet==null || !resultSet.next()){
				...
				case "2":
					...
					break;
				case "3":
					//columnName="APPLICANT_ELIGIBILITY";
				...
				case "4":
					...
					break;
				case "5":
					//columnName="DEGREE_CERTIFICATE_OFFERED";
...
//					e.printStackTrace();
	...
	public List<ProgramOfferedBean> viewProgramOffered()
		...
		try
		{
			...
			{	
				...
				programOffered.setDuration(resultset.getString(4));
	...
	public String addSchedule(ProgramScheduledBean programScheBean) throws UniversityException{
		...
		try{
			...
			//con = db.getDbConnect();//DBConnection.getInstance().getConnection();
			...
			psmt.setString(3,  programScheBean.getStartDate());
			psmt.setString(4, programScheBean.getEndDate());
			psmt.setString(5, programScheBean.getSessionsPerWeek());
	...
	public ArrayList<ProgramScheduledBean> viewSchedule(String startDate, String endDate) throws UniversityException{
		...
		try{
			...
			while(res.next()){
				...
				bean.setStartDate(res.getString(4));
				bean.setEndDate(res.getString(5));
				bean.setSessionsPerWeek(res.getString(6));
